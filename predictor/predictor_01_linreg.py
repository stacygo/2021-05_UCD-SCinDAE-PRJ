...
if __name__ == '__main__':
    ...
    print('\nCompute and print the tuned parameters and metrics\n')
    print("Tuned LinearRegression Parameters: {}".format(pipeline_cv.best_params_))
    print("Tuned LinearRegression R squared: {}".format(r2))
    print("Tuned LinearRegression RMSE: {}".format(rmse))
